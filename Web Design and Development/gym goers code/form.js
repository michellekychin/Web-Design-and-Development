...
form passes an initial validation test.
...
customers don't have to continually retype test values
in the survey form.
...
function init() {
   document.forms[0].onsubmit = function() {
      if (this.checkValidity()) alert("Your order was submited. Thank you for having us!!");
      return false;
   }
